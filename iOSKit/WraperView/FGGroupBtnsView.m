...
//            make.bottom.equalTo(self.mas_centerY).offset(-AdaptedHeight(3));
//        }];
//        
//        [tiitleLable mas_makeConstraints:^(MASConstraintMaker *make) {
//            make.centerX.equalTo(self.mas_centerX);
//            make.top.equalTo(self.mas_centerY).offset(AdaptedHeight(7));
//        }];
        [imgView mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setupViewsWithModel:(NSArray<FGGroupBtnsModel*> *)models
{
    ...
    for (int i = 0; i < models.count ; i++ ) {
        ...
        [btn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.mas_equalTo((self.width - (_column + 1) * spacing)/_column);
            if (i > 0) {
            ...
            if (i == (models.count - 1)) {
                make.bottom.equalTo(self.mas_bottom).offset(AdaptedWidth(-20));
            }
