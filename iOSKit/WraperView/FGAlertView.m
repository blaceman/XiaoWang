...
- (void)setupViews
{
    ...
    self.messageLable.font = AdaptedFontSize(15);
    ...
    if (self.btnNames.count > 1) {
        ...
        [self.cancelBtn setTitleColor:UIColorTheme forState:UIControlStateNormal];
        self.cancelBtn.layer.cornerRadius = AdaptedWidth(40)/2;
        self.cancelBtn.clipsToBounds = YES;
        self.cancelBtn.layer.borderColor = UIColorTheme.CGColor;
        self.cancelBtn.layer.borderWidth = 1;
        self.cancelBtn.titleLabel.font = AdaptedFontSize(15);
    ...
    [self.certainBtn setBackgroundImage:UIImageWithName(@"ic_coin") forState:UIControlStateNormal];
    [self.certainBtn setTitleColor:UIColorFromHex(0xffffff) forState:UIControlStateNormal];
    self.certainBtn.titleLabel.font =AdaptedFontSize(15);
...
- (void)setupLayout
{
    ...
    if (self.btnNames.count > 1) {
        [self.cancelBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self.containerView.mas_centerX).offset(AdaptedWidth(-16));
            make.top.equalTo(self.messageLable.mas_bottom).offset(AdaptedWidth(20));
        ...
        [self.certainBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(self.containerView.mas_centerX).offset(AdaptedWidth(16));
            make.top.equalTo(self.messageLable.mas_bottom).offset(AdaptedWidth(20));
            make.height.mas_equalTo(AdaptedWidth(40));
            make.width.mas_equalTo(AdaptedWidth(40 * 201/92.0));
            make.bottom.equalTo(self.containerView).offset(AdaptedWidth(-26));
        }];
    }else{
        [self.certainBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self.containerView.mas_centerX);
