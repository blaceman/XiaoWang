...
@interface FGBaseWebView ()<UIAlertViewDelegate>
...
//        [request setValue:[GVUserDefaults standardUserDefaults].ticket forHTTPHeaderField:@"X-API-Token"];
...
- (void)webViewDidStartLoad:(UIWebView *)webView
{
    ...
    {
        [self.delegate fgwebViewDidStartLoad:self];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if(webView == self.uiWebView)
    {
        ...
        if(![self externalAppRequiredToOpenURL:request.URL])
        {
            ...
            //back delegate
            [self.delegate fgwebView:self shouldStartLoadWithURL:request.URL];
            return YES;
        }
        else
        {
    ...
    BOOL headerIsPresent = [[request allHTTPHeaderFields] objectForKey:@"X-API-Token"]!=nil;
...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    if(webView == self.uiWebView)
    {
        ...
        //back delegate
        [self.delegate fgwebView:self didFinishLoadingURL:self.uiWebView.request.URL];
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error
{
    if(webView == self.uiWebView)
    {
        ...
        [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
        //back delegate
        [self.delegate fgwebView:self didFailToLoadURL:self.uiWebView.request.URL error:error];
    }
}
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    if(webView == self.wkWebView)
    {
        [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
        //back delegate
        [self.delegate fgwebView:self didFinishLoadingURL:self.wkWebView.URL];
    }
}
      ...
      withError:(NSError *)error
{
    ...
    {
        //back delegate
        [self.delegate fgwebView:self didFailToLoadURL:self.wkWebView.URL error:error];
    }
